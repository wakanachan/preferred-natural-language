...
try {
  ...
  execSync(`${which} pnl`, { stdio: 'ignore' });

  console.error('[MCP Launcher] Using globally installed pnl');
  ...
  // 全局命令未找到，使用 npx
  console.error('[MCP Launcher] Global pnl not found, falling back to npx...');
